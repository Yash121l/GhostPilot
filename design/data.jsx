...
const SEED_POSTS = [
  {
    ...
    hour: 9,
    platform: 'linkedin',
    title: 'Solo founders & focus rituals',
    status: 'scheduled'
  },
  {
    id: 'p2',
    ...
    hour: 14,
    platform: 'twitter',
    title: 'A 4-tweet thread on shipping rhythm',
    status: 'scheduled'
  },
  {
    id: 'p3',
  ...
  },
  {
    ...
    hour: 8,
    platform: 'linkedin',
    title: 'Q2 lessons from indie hacking',
    status: 'draft'
  },
  {
    id: 'p5',
    ...
    hour: 11,
    platform: 'twitter',
    title: 'Why I killed three side projects',
    status: 'scheduled'
  },
  {
    id: 'p6',
    ...
    hour: 15,
    platform: 'linkedin',
    title: 'Hiring my first contractor',
    status: 'scheduled'
  }
]
...
const SEED_PERSONAS = [
  {
    ...
    style:
      'Casual, first-person, short sentences. No corporate jargon. Specific numbers > vague claims.',
    posts: 47,
    voice: 78
  },
  {
    id: 'studio',
    name: 'GhostPilot — Brand',
...
const SEED_GOALS = [
  {
    id: 'g1',
    name: 'Reach 5K LinkedIn followers by Sep',
    north: '5,000 LinkedIn followers',
    progress: 0.42,
    current: 2089,
    target: 5000,
    weekly: 4,
  ...
  {
    id: 'g2',
    name: 'Build a Twitter audience around AI tooling',
    north: '10K X followers',
    progress: 0.18,
    current: 1810,
    target: 10000,
    weekly: 7,
...
const SEED_TRENDS = [
  {
    id: 't1',
    title: 'Cursor 1.0 shipped — devs are split on the agent UX',
    source: 'hackernews',
    tag: 'RISING',
    relevance: 86,
    velocity: 72,
  ...
  {
    id: 't2',
    title: 'Solo founders are killing newsletters in favor of LinkedIn',
    source: 'reddit',
    tag: 'RISING',
    relevance: 78,
    velocity: 64,
  ...
  {
    id: 't3',
    title: '"Vibe coding" is the new no-code — pros and cons',
    source: 'reddit',
    tag: 'HOT',
    relevance: 71,
    velocity: 88,
  ...
  {
    id: 't4',
    title: 'Local Llama 3.3 benchmarks vs Claude Haiku — closer than you think',
    source: 'hackernews',
    tag: 'RISING',
    relevance: 82,
    velocity: 56,
  ...
  {
    id: 't5',
    title: 'Why senior engineers struggle to communicate technical decisions',
    source: 'hackernews',
    tag: 'STEADY',
    relevance: 64,
    velocity: 31,
  ...
  {
    id: 't6',
    title: 'Indie devs are charging less than they think — pricing survey',
    source: 'reddit',
    tag: 'RISING',
    relevance: 74,
    velocity: 60,
...
const SEED_ANALYTICS = {
  ...
  topPosts: [
    {
      title: 'The framework I use to kill features fast',
      platform: 'linkedin',
      reach: 8412,
      eng: 9.4
    },
    {
      title: '4 tools I replaced with a 200-line script',
      platform: 'twitter',
      reach: 4280,
      eng: 7.1
    },
    {
      title: 'Why I stopped journaling and started shipping',
      platform: 'linkedin',
      reach: 3960,
      eng: 6.8
    }
...
function generateVariants(draft) {
  ...
  const seed =
    trimmed ||
    "I spent six months building the wrong thing. Here's what I learned about validating ideas before writing code."
  const firstSentence = seed.split(/[.!?]/)[0].trim() || seed.slice(0, 80)
  const restOfText =
    seed.length > firstSentence.length ? seed.slice(firstSentence.length + 1).trim() : ''
  ...
  return {
    ...
    instagram: {
      caption: (
        ...
        '.\n\n' +
        (restOfText ||
          'swipe → for the three lessons that changed how i ship.\n\n#indiehacker #buildinpublic #startup #founder')
      ).slice(0, 600),
      chars: 280,
      optimal: '125–150 for first line'
    }
  }
}
